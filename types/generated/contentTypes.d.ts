...
export interface ApiReturnResponseReturnResponse
  extends Struct.CollectionTypeSchema {
  collectionName: 'return_responses';
  info: {
    displayName: 'ReturnResponse';
    pluralName: 'return-responses';
    singularName: 'return-response';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::return-response.return-response'
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::return-response.return-response': ApiReturnResponseReturnResponse;
